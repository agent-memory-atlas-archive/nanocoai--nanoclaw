 ...
 * is the reap-visibility surface: pods reap on the in-pod idle lease ,
...
registerResource({
  ...
  table: 'agent_groups',
  description:
    'Sandbox — a code-mode agent group behind the ssh door: a durable workspace whose disposable session pod wakes on attach  and reaps on the in-pod idle lease . Operator-only.',
  idColumn: 'id',
  columns: [
  ...
  customOperations: {
    ...
    list: {
      ...
      description:
        ...
        "'cold' means the idle lease reaped the pod  — the workspace is durable and " +
