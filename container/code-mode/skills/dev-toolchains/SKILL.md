...
Use versions declared by the project. For a Kubernetes environment, install a
compatible `kubectl` when needed. Docker environments do not give the sandbox
access to the Docker daemon; use `ncl envs` to manage them.
